...
import { ArrowRight, BookOpen, Mail, Mic, Radio } from "lucide-react";
...
const audioStories = [
	{
		...
		duration: "6:30",
		description:
			"Ralph Peer arrived in Bristol with a microphone and a hunch. Twelve days later, country music had a birthplace.",
	},
	{
		...
		duration: "5:15",
		description:
			"How the Virginia & Tennessee Railroad turned Bristol into a crossroads of American music.",
	},
	{
		...
		duration: "7:00",
		description:
			"The guitar technique that changed American music — and the woman who invented it.",
	},
	{
		...
		duration: "5:45",
		description:
			"How Appalachian ballads, blues, and gospel collided in the Tri-Cities to create something new.",
	},
	{
		...
		duration: "6:15",
		description:
			"The story of Bristol Rhythm & Roots Reunion — from a small street festival to a national destination.",
	},
];
...
const storyChapters = [
	...
	},
	{
		...
		excerpt:
			"How a downtown festival became one of the region's clearest signs that the music is still alive.",
	},
	{
			...
			<section className="bg-burgundy-900 px-4 py-20 text-white sm:py-28">
				<div className="mx-auto max-w-4xl text-center">
					...
					<p className="mx-auto max-w-2xl text-lg leading-relaxed text-burgundy-200">
						The trail chapters are live now. Audio stories are still in production, and
						they&rsquo;ll appear here as they&rsquo;re ready.
					</p>
				</div>
			</section>
				...
				<div className="mx-auto max-w-5xl space-y-16">
					<div>
						...
						<p className="mb-6 max-w-3xl text-sm leading-relaxed text-stone-600">
							These are the first story topics planned for the listening experience. We&rsquo;ll
							replace the placeholders below with live audio as each episode is finished.
						</p>
					...
					<div className="rounded-2xl bg-burgundy-800 p-8 text-white">
						...
						<p className="mb-6 max-w-xl text-burgundy-200">
							...
							historians. Join the newsletter and we&rsquo;ll announce it when the first season is
							ready.
						</p>
						<div className="flex flex-wrap gap-3">
							<span className="rounded-full bg-burgundy-700 px-4 py-2 text-sm">Launch updates</span>
							<span className="rounded-full bg-burgundy-700 px-4 py-2 text-sm">
								Guest announcements
							</span>
							<span className="rounded-full bg-burgundy-700 px-4 py-2 text-sm">
