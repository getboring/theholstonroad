		...
		<main>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-3xl space-y-8 text-lg leading-relaxed text-stone-700">
					<p>
						In July and August of 1927, Ralph Peer set up a temporary recording studio in a
						converted hat warehouse at 408 State Street in Bristol, Tennessee. He had a microphone,
						a disc-cutting machine, and a hunch that rural musicians had commercial potential. He
						was right.
					</p>
					<p>
						Over twelve days, Peer recorded nineteen acts. The Carter Family — A.P., Sara, and
						Maybelle — walked in with songs learned from old ballads and church hymns. Jimmie
						Rodgers, a former railroad worker, brought a yodel and a blues sensibility that nobody
						had heard before. Ernest Stoneman, Blind Alfred Reed, and a dozen others added their own
						sounds to the mix.
					</p>
					<p>
						...
						And Bristol became the Birthplace of Country Music — a designation Congress made
						official in 1998.
					</p>
					<p>
						...
						>
							...
							<div>
								...
								<p className="text-sm text-stone-600">
									Bristol, TN — Historic theater on State Street
								</p>
							</div>
						</Link>
					</div>
