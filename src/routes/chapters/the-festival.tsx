    ...
    <main>
      <section className="bg-amber-700 px-4 py-20 text-white sm:py-28">
        <div className="mx-auto max-w-4xl">
          <p className="mb-2 text-sm font-medium uppercase tracking-widest text-amber-300">Chapter 4</p>
          <h1 className="mb-6 font-display text-5xl font-bold tracking-tight sm:text-6xl">The Festival</h1>
      ...
      <section className="px-4 py-16">
        <div className="mx-auto max-w-3xl space-y-8 text-lg leading-relaxed text-stone-700">
          <p>
            ...
            party celebrating the music that was born here? They called it the Bristol Rhythm & Roots
            Reunion. Twenty years later, it's one of the most celebrated roots music festivals in America.
          </p>
          <p>
            ...
            The Birthplace of Country Music Museum hosts special exhibits. Local venues host after-parties
            that run until the early morning.
          </p>
          <p>
            The Crooked Road — Virginia's Heritage Music Trail — presents heritage music at the festival
            annually, connecting Southwest Virginia to Northeast Tennessee. ETSU students play side stages.
            Local pickers host impromptu jams on street corners. And every year, someone discovers a
            sound they didn't know they were looking for.
          </p>
          <p>
            The Reunion isn't a museum piece. It's proof that the music born in 1927 didn't die when
            the recordings stopped. It just moved outside — onto the same street, in front of the same
            buildings, played by a new generation of musicians who understand exactly what they're
            inheriting.
          </p>
          <div className="rounded-xl border-l-4 border-amber-600 bg-amber-50 p-6">
            ...
            <p className="mt-2 text-stone-700">
              What tradition would you celebrate if you could shut down your whole town for a weekend?
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Link to="/sites/$slug" params={{ slug: 'paramount-bristol' }} className="group flex gap-4 rounded-xl border border-stone-200 bg-white p-5 transition hover:shadow-md">
              ...
              <div>
                <h3 className="font-display text-lg font-bold text-stone-900 group-hover:text-amber-700 transition">Bristol Paramount</h3>
