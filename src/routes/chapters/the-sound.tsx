		...
		<main>
			<section className="bg-burgundy-800 px-4 py-20 text-white sm:py-28">
				<div className="mx-auto max-w-4xl">
					<p className="mb-2 text-sm font-medium uppercase tracking-widest text-burgundy-300">
						Chapter 1
					</p>
					...
					<p className="max-w-2xl text-xl leading-relaxed text-burgundy-200">
						The mountains shaped the music. Appalachian ballads, blues, and gospel collided in the
						Tri-Cities to create something entirely new.
					</p>
				</div>
			</section>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-3xl space-y-8 text-lg leading-relaxed text-stone-700">
					<p>
						Before there were recording studios, there were front porches. Before there were radio
						stations, there were church congregations. And before there was country music, there
						were the sounds of the mountains — ballads brought from the British Isles, spirituals
						from African American churches, and blues from the Deep South.
					</p>
					<p>
						The Tri-Cities sat at the intersection of these traditions. Bristol, on the
						Tennessee-Virginia border, was a crossroads. The railroad brought musicians from
						Appalachia, the Piedmont, and the Mississippi Delta. They traded songs, borrowed
						techniques, and created a new sound that didn't exist anywhere else.
					</p>
					<p>
						The Carter Family learned their songs from old British ballads and church hymns. Jimmie
						Rodgers blended blues yodeling with mountain lyrics. The result was a music that sounded
						like America — not one region, but many, distilled into something you could dance to,
						cry to, or sing along with on a front porch.
					</p>
				...
				<div className="mx-auto max-w-4xl">
					...
					<div className="grid gap-6 md:grid-cols-2">
						...
						>
							...
							<div>
								<h3 className="font-display text-lg font-bold text-stone-900 group-hover:text-burgundy-700 transition">
