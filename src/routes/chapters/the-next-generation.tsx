		...
		<main>
			<section className="bg-burgundy-900 px-4 py-20 text-white sm:py-28">
				<div className="mx-auto max-w-4xl">
					...
					<p className="max-w-2xl text-xl leading-relaxed text-burgundy-200">
						ETSU's Bluegrass, Old Time and Country Music program is one of the most respected in the
						nation. Young players are keeping the tradition alive — and making it their own.
					</p>
				</div>
			</section>
			...
			<section className="px-4 py-16">
				<div className="mx-auto max-w-3xl space-y-8 text-lg leading-relaxed text-stone-700">
					<p>
						In 1982, East Tennessee State University did something unusual: it started a degree
						program in bluegrass, old-time, and country music. Students would study music theory,
						history, and business — but they'd also study under master musicians who had played with
						Bill Monroe, Flatt & Scruggs, and the Stanley Brothers.
					</p>
					<p>
						Forty years later, the program is one of the most respected in the nation. Students come
						from across the country and around the world to study in Johnson City. They learn
						flatpicking from guitar legends. They learn old-time fiddle from players who learned it
						from players who learned it in the mountains. They learn the business of music — how to
						book shows, manage a career, and keep a tradition alive in a world that doesn't always
						value it.
					</p>
					<p>
