    ...
    <main>
      <section className="bg-walnut-700 px-4 py-20 text-white sm:py-28">
        <div className="mx-auto max-w-4xl">
          <p className="mb-2 text-sm font-medium uppercase tracking-widest text-walnut-300">Chapter 2</p>
          <h1 className="mb-6 font-display text-5xl font-bold tracking-tight sm:text-6xl">The Railroad</h1>
      ...
      <section className="px-4 py-16">
        <div className="mx-auto max-w-3xl space-y-8 text-lg leading-relaxed text-stone-700">
          <p>
            In 1856, the Virginia & Tennessee Railroad reached Bristol. For the first time, the mountain
            communities of Appalachia were connected to the rest of the country by something faster than
            a horse. By the 1920s, that railroad had made Bristol a destination.
          </p>
          <p>
            ...
            home counties — could board a train and arrive in Bristol with their instruments and their songs.
          </p>
          <p>
            The railroad also brought the recording technology. Those heavy disc-cutting machines,
            the microphones, the amplifiers — all of it traveled by train. And when the sessions were
            done, the master discs traveled back out the same way, bound for pressing plants in
          ...
          <div className="rounded-xl border-l-4 border-amber-600 bg-amber-50 p-6">
            ...
            <p className="mt-2 text-stone-700">
              What journey changed the way you hear music?
            </p>
          </div>
        </div>
      </section>
